 ...
 */
export default function adminWithAuth<T extends WithAuthProps = WithAuthProps>(
  ...
  const ComponentWithAuth = (props: Omit<T, keyof WithAuthProps>) => {
    ...
    //#region  //*=========== STORE ===========
    const isAuthenticated = useAdminStore.useIsAuthenticated();
    const isLoading = useAdminStore.useIsLoading();
    const login = useAdminStore.useLogin();
    const logout = useAdminStore.useLogout();
    const stopLoading = useAdminStore.useStopLoading();
    const user = useAdminStore.useUser();
    //#endregion  //*======== STORE ===========
